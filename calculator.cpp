    ...
    switch(Message) {
        case WM_CREATE:
            ...
            button = CreateWindow("BUTTON", "+",
                WS_VISIBLE | WS_CHILD | WS_BORDER, 50, 120, 30, 30, hwnd, (HMENU)1, NULL, NULL);

            button = CreateWindow("BUTTON", "-",
                WS_VISIBLE | WS_CHILD | WS_BORDER, 90, 120, 30, 30, hwnd, (HMENU)2, NULL, NULL);

            button = CreateWindow("BUTTON", "*",
                WS_VISIBLE | WS_CHILD | WS_BORDER, 130, 120, 30, 30, hwnd, (HMENU)3, NULL, NULL);

            button = CreateWindow("BUTTON", "/",
                WS_VISIBLE | WS_CHILD | WS_BORDER, 170, 120, 30, 30, hwnd, (HMENU)4, NULL, NULL);

            TextBox1 = CreateWindow("EDIT", "", WS_CHILD | WS_VISIBLE,
                50, 55, 150, 20, hwnd, NULL, NULL, NULL);
			
			TextBox2 = CreateWindow("EDIT", "", WS_CHILD | WS_VISIBLE,
				50, 85, 150, 20, hwnd, NULL, NULL, NULL);
            break;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    wc.hbrBackground = CreateSolidBrush(RGB(51, 255, 252));
